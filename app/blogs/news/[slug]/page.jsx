...
export default async function BlogPostPage({ params }) {
  ...
  return (
    <article className="min-h-screen bg-white text-neutral-900 pb-24 select-none">
      ...
      {/* 3. Hero Visual Asset (Full Bleed Inside Container) */}
      ...
      <div className="max-w-[820px] mx-auto px-6 sm:px-10 text-neutral-800 space-y-6 text-base sm:text-lg leading-relaxed font-normal">
        ...
        <div className="mt-12 p-8 bg-[#fafafa] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
          ...
          <Link
            href="/shop"
            className="px-6 py-3 bg-neutral-950 hover:bg-blue-600 text-white font-black text-xs uppercase tracking-widest transition-colors shrink-0"
          >
            Explore Catalog
          </Link>
        </div>
      ...
      {/* 5. CSUK-STYLE "NEXT STORY" BOTTOM SECTION */}
      {nextPost && (
        <section className="max-w-[1200px] mx-auto px-6 sm:px-10 mt-28 pt-12 border-t border-neutral-200">
          ...
          >
            <div className="md:col-span-5 aspect-[16/10] bg-[#f5f5f5] overflow-hidden">
              <img
